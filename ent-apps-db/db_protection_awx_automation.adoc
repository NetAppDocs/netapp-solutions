...
.. Provide the name of the group for the source ONTAP cluster, paste the group variables (if any) and click Save.
...
.. Provide the IP address of the Source ONTAP cluster management IP, paste the host variables (if any), and click Save.
.. This process must be repeated for the Oracle group and Source Oracle host(s) management IP/hostname.
...
.. Under Type Details, enter the username, password.
