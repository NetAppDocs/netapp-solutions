---
sidebar: sidebar
permalink: saphana_aff_nfs_storage_sizing.html
keywords:
summary:
---
...
The 6Gb SAS disk shelf (DS2246) supports a maximum of four SAP HANA hosts. The SSDs and the SAP HANA hosts must be equally distributed between both storage controllers.
 ...
 summarizes the supported number of SAP HANA hosts per disk shelf.
...
NetApp conducted performance tests to define the optimal values.  lists the parameters that must be set within the configuration file of the SAP performance test tool.
