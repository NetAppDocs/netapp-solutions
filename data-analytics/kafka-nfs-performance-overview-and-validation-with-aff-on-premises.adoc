...
image:kafka-nfs-image32.png["Figure showing input/output dialog or representing written content"]
...
image:kafka-nfs-image35.png["Figure showing input/output dialog or representing written content"]
