...
For Datalake and lakehouse,  storageGRID is NetApp primary object storage and ONTAP for file/object duality, In this document, we have tested ontap s3 for the customer request and works as a source of data.
