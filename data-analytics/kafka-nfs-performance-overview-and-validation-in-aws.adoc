...
3. Validate the credentials by login into Fsx for NetApp ONTAP SSH with the fsxadmin user:
...
8.	Next, for additional performance and capacity,We extend the FSx for NetApp ONTAP throughput capacity from 2GB/Sec to 4GB/Sec and IOPS to 160000, and capacity to 5 TB
+
....
