...
* link:https://docs.netapp.com/us-en/netapp-solutions/vmware/vsphere_ontap_best_practices.html#vsphere-datastore-and-protocol-features[NetApp ONTAP supports all storage protocols]
...
* link:https://docs.netapp.com/us-en/netapp-solutions/vmware/vvols-overview.html[vVols Technical Documentation]
...
* link:vsrm-ontap9_1_introduction_to_srm_with_ontap.html[VMware Site Recovery Manager with NetApp ONTAP 9]
