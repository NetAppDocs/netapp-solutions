...
* link:https://docs.netapp/com/us-en/vontap-apps-dbs/vmware/vmware-vsphere-overview.html[NetApp ONTAP supports all storage protocols]
...
* link:https://docs.netapp.com/us-en/ntap-apps-dbs/vmware/vmware-srm-overview.html[VMware Site Recovery Manager with NetApp ONTAP 9]
