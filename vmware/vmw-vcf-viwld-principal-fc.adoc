...
* Utilize single initiator-target zoning on FC switches.
...
* IP addresses reserved for vMotion storage traffic on the VLAN or network segment established for this purpose.
