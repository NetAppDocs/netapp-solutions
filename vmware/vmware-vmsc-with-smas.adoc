...
* link:vmware_vcf_asa_supp_mgmt_iscsi.html#deployment-steps[VMware vSphere hosts deployed with dual storage fabric (Two HBAs or Dual VLAN for iSCSI) per host].
...
* link:vmware_vcf_asa_supp_mgmt_iscsi.html#deployment-steps[Storage VM and LIFs are available]
