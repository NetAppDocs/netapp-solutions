---
sidebar: sidebar
permalink: vmware/vmware_vcf_asa_overview_new.html
...
This solution highlights the use of NetApp All-Flash SAN arrays, ONTAP Tools for VMware and NetApp SnapCenter Plug-in for VMware vSphere in the context of primary and supplemental storage across a variety of protocols. 
