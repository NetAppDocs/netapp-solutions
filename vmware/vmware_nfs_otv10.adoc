...
+
image::vmware-nfs-otv10-image15[Add storage backend]
+
{nbsp}
. On the *Add Storage Backend* box, fill out the credentials for the ONTAP storage system.
+
image::vmware-nfs-otv10-image16[Add storage backend]
+
{nbsp}
