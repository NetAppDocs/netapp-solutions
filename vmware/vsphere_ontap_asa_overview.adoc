...
For more information on vVols see the https://www.vmware.com/docs/vmw-vsphere-virtual-volumes-vvolvs-getting-started-guide[vVols Getting Started Guide].

===== NVMe over Fabrics
With the release of vSphere 8.0, NVMe is now supported end-to-end with full support for vVols with NVMe-TCP and NVMe-FC. 

For detailed information on using NVMe with vSphere refer to https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-storage-8-0/about-vmware-nvme-storage.html[About VMware NVMe Storage] in the vSphere Storage documentation.
