...
For more information regarding the top ONTAP Benefits for VMware VCF identified below see link:https://review.docs.netapp.com/us-en/netapp-solutions_vmware317/vmware/vmw-getting-started-overview.html#why-ontap-for-vmware[Why ONTAP for VMware].
