...
image:vvols-image5.png[ONTAP tools VASA Provider architecture,480,320]
...
image:vvols-image6.png[ONTAP tools vVols dashboard,640,320]
...
image:vvols-image8.png[network configuration using vVols over NFS v,640,320]
|===