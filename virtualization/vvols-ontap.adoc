...
image:vvols-image5.png[ONTAP tools VASA Provider architecture,400,600]
...
image:vvols-image6.png[ONTAP tools vVols dashboard,480,320]
...
image:vvols-image7.gif[Single initiator zoning withs four nodes,480,320]
...
image:vvols-image8.png[network configuration using vVols over NFS v3,640,320]
|===