...
//  THE PREVIOUS SECTION TO DEVELOPED SPECIFIC TO NFS DESIGN CONSIDERATIONS
...
+
{nbsp}
. Repeat this entire process for each ESXi host in the cluster.
====
