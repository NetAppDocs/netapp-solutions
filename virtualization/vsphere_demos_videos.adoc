...
For more information about NetApp SnapCenter Plug-in for VMware vSphere, see the https://docs.netapp.com/ocsc-41/index.jsp?topic=%2Fcom.netapp.doc.ocsc-con%2FGUID-49D66AC0-F012-4993-80BD-8F3353F80220.html/[NetApp SnapCenter Plug-in for VMware vSphere Overview^].
