...
* https://docs.netapp.com/us-en/netapp-solutions/virtualization/scv_videos_deployment.html[SnapCenter Plug-in for VMware vSphere - Deployment^]
* https://docs.netapp.com/us-en/netapp-solutions/virtualization/scv_videos_prerequisites.html[SnapCenter Plug-in for VMware vSphere - Solution Pre-Requisites^]
* https://docs.netapp.com/us-en/netapp-solutions/virtualization/scv_videos_backup_workflow.html[SnapCenter Plug-in for VMware vSphere - Backup Workflow^]
* https://docs.netapp.com/us-en/netapp-solutions/virtualization/scv_videos_restore_workflow.html[SnapCenter Plug-in for VMware vSphere - Restore Workflow^]
* https://docs.netapp.com/us-en/netapp-solutions/virtualization/scv_videos_sql_restore.html[SnapCenter - SQL Restore Workflow^]
