...
image:vvols-image17.png[vVols replication with SRM,480,320]
...
image:vvols-image18.png[SnapCenter architecture,480,320]
...
image:vvols-image19.png[Resource group notification options,480,320]
