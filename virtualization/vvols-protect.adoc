...
image:vvols-image17.png[vVols replication with SRM,400]
...
image:vvols-image18.png[SnapCenter architecture,400]
...
image:vvols-image19.png[Resource group notification options,400]
