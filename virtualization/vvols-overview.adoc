...
[%autowidth.stretch]
|===
| image:vvols-image1.png[Lightbulb and gear with solid fill,64,48]
| Thisis document has been updated to include new vVols features found in vSphere 8.0 update 1 which are supported with the ONTAP tools 9.12 release.
|===
