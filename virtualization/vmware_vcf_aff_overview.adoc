...
=== VCF Storage Options
VMware divides storage options for VCF into Principal and Supplemental storage options. The VCF Management Domain must use vSAN as its Principal storage. However, there are many supplemental storage options for the Management Domain and both principal and supplemental storage options available for VI Workload Domains.
