...
* Configure and use an NFS datastore as principal storage during VI Workload Domain deployment.
* Configure and use a vVol datastore as principal storage during VI Workload Domain deployment.
* Install and demonstrate the use of ONTAP Tools to configure and mount NFS and iSCSI (VMFS) datastores as supplemental storage in VI Workload Domains.
