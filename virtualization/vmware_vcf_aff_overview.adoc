...
* *Configure and use an NFS datastore as principal storage during VI Workload Domain deployment.* Click https://docs.netapp.com/us-en/netapp-solutions/virtualization/vsphere_ontap_auto_block_fc.html[*here*] for deployment steps.
* *Install and demonstrate the use of ONTAP Tools to configure and mount NFS datastores as supplemental storage in VI Workload Domains.* Click https://docs.netapp.com/us-en/netapp-solutions/virtualization/vsphere_ontap_auto_block_fc.html[*here*] for deployment steps.
