...
image:vvols-image9.png[Storage Capabilities for ONTAP tools 9.10 and later,640]

image:vvols-image10.png[Storage Capabilities for ONTAP tools 9.10 and later,640]

image:vvols-image11.png[Storage Capabilities for ONTAP tools 9.10 and later,640] 

image:vvols-image12.png[Storage Capabilities for ONTAP tools 9.10 and later,640]

image:vvols-image13.png[Storage Capabilities for ONTAP tools 9.10 and later,640]

image:vvols-image14.png[Storage Capabilities for ONTAP tools 9.10 and later,640]
...
image:vvols-image15.png[VM Storage Policy creation with ONTAP tools VASA Provider 9.10,700,500]
...
image:vvols-image16.png[Reapplying VM Storage Policy,700,480]
