...
image:vvols-image9.png["Storage Capabilities for ONTAP tools 9.10 and later",400]

image:vvols-image10.png["Storage Capabilities for ONTAP tools 9.10 and later",400]

image:vvols-image11.png["Storage Capabilities for ONTAP tools 9.10 and later",400] 

image:vvols-image12.png["Storage Capabilities for ONTAP tools 9.10 and later",400]

image:vvols-image13.png["Storage Capabilities for ONTAP tools 9.10 and later",400]

image:vvols-image14.png["Storage Capabilities for ONTAP tools 9.10 and later",400]
