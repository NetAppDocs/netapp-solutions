...
.On-Prem
--
include::databases/db_protection_onprem_creds.adoc[]
--
.CVO
--
include::databases/db_protection_cvo_creds.adoc[]
--
====
...
.On-Prem
--
include::databases/db_protection_onprem_vars.adoc[]
--
.CVO
--
include::databases/db_protection_cvo_vars.adoc[]
--
====
...
.ONTAP/CVO Setup
--
include::databases/db_protection_ontap_cvo_setup.adoc[]
--
.Replication For Binary and Database Volumes
--
include::databases/db_protection_db_replication.adoc[]
--
.Replication for Log Volumes
--
include::databases/db_protection_log_replication.adoc[]
--
.Restore and Recover Database
--
include::databases/db_protection_restore_recovery.adoc[]
--
====
