...
| Oracle Grid Infrastructure | Version 19.18 | Applied RU patch on top of 19.3 base release 
| Oracle Database | Version 19.18 | | Applied RU patch on top of 19.3 base release 
| Oracle OPatch | Version 12.2.0.1.36 | Required for version 18 of RU patch
