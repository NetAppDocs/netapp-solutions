...
Refer to link:https://docs.netapp.com/us-en/netapp-solutions/databases/automation_ora_aws-fsx_iscsi.html[TR-4986: Simplified, Automated Oracle Deployment on Amazon FSx ONTAP with iSCSI^] for details.
