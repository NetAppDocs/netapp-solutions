...
| ora_02 | cdb2(cdb2_pdb1,cdb2_pdb2,cdb2_pdb3) | iSCSI luns on ASA A400
|===
...
After the playbook run, login to the Oracle DB server as oracle user to validate that Oracle grid infrastructure and database are created successfully.  
