...
Refer to TR-XXX section `Oracle backup, restore, and clone with SnapCenter` for details on how to setup SnapCenter and execute the database backup, restore, and clone workflow.
