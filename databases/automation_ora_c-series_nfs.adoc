...
summary: "The solution provides overview and details for automated Oracle deployment in NetApp C-Series as primary database storage with NFS protocol and Oracle database is deployed as container database with dNFS enabled." 
---
