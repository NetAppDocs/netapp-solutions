...
Follow these instruction to set up your Ansible control node for RedHat or CentOS machines: link:../automation/automation_rhel_centos_setup.html[RedHat/CentOS Ansible Controller Setup^].
Follow these instruction to set up your Ansible control node for Ubuntu or Debian machines: link:../automation/automation_ubuntu_debian_setup.html[Ubuntu/Debian Ansible Controller Setup^].
