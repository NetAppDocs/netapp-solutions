...
--------- ------------ ------------ ---------- ---- ---------- ---------- -----
svm_ora   ora_01_data  aggr1        online     RW      148.8GB    29.01GB   79%
svm_ora   ora_01_logs  aggr1        online     RW      148.8GB    86.97GB   38%
svm_ora   ora_01_biny  aggr1        online     RW         50GB    21.78GB   54%
svm_ora   svm_ora_root aggr1        online     RW          1GB    972.0MB    0%
...
. Mount the binary volume to `/u01`, changed to your FSx NFS lif IP address
+
....
...
. Login to DB instance to validate dNFS after instance reboot
+
....
...
+
....
[oracle@ip-172-30-15-25 db1]$ asm
[oracle@ip-172-30-15-25 db1]$ sqlplus / as sysasm
...
Version 19.18.0.0.0
  ...
  1* select name, path, header_status, mount_status,state from v$asm_disk
SQL> /
