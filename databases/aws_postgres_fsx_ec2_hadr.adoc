...
video::e479b91f-eacd-46bf-bfa1-b01200f0015a[panopto, title="Automated PostgreSQL Deployment and Protection"]
...
. Set up the Ansible controller as described in the section "Set up the Ansible Control Node for CLI deployments on RHEL/CentOS" from the resource link:../automation/getting-started.html[Getting Started with NetApp solution automation]. 
