...
* The DBA who is interested in deploying PostgreSQL with HA/DR in the AWS public cloud.
* The database solution architect who is interested in testing PostgreSQL workloads in the AWS public cloud.
