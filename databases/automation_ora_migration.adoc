...
* Setup FSx ONTAP - cluster peering, vserver peering, Oracle volumes snapmirror relationship setup from Primary to DR.
...
* A database solution architect interested in Oracle storage level HA/DR solution in the AWS cloud.
