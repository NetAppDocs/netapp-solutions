...
Database clone procedures are similar to restore but to an alternate Azure VM database host with identical Oracle software stack pre-installed and configured.
