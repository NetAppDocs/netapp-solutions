...
link:../automation/automation_rhel_centos_setup.html[click here for RHEL 7/8 or CentOS 7/8], or
link:../automation/automation_ubuntu_debian_setup.html[here for Ubuntu/Debian]
