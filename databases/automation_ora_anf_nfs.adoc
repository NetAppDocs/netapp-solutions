...
For Azure VMs deployed with local disk redundancy, ensure that you have allocated at least 128G in VM root disk to have sufficient space to stage Oracle installation files and add OS swap file.
