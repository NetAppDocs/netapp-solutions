...
| ora_01 | cdb1(cdb1_pdb1,cdb1_pdb2,cdb1_pdb3) | VMDK datastore on FSx
| ora_01 | cdb2(cdb2_pdb) | VMDK datastore on FSx 
| ora_02 | cdb3(cdb3_pdb1,cdb3_pdb2,cdb3_pdb3) | Direct guest mounted FSx
| ora_02 | cdb4(cdb4_pdb) | Direct guest mounted FSx
|===
