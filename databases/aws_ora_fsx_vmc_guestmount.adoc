...
| BlueXP backup and recovery for VMs | Release 1.0 | Deployed to VMC as an ova vSphere plugin VM
| VMware vSphere | Version 8.0.1.00300 | VMware Tools, Version: 11365 - Linux, 12352 - Windows 
| Open JDK | Version 1.8, java-1.8.0-openjdk.x86_64 | Required for running SnapCenter plugin on DB VMs 
|===
