...
^| link:azure-guest.html#cvo[Guest Connected]
^| link:aws-guest.html#cvo[Guest Connected]
^| link:gcp-guest.html#cvo[Guest Connected]
//
| *Cloud Volumes Service (CVS)*
^| -
^| -
^| link:gcp-guest.html#cvs[Guest Connected]
link:https://www.netapp.com/google-cloud/google-cloud-vmware-engine-registration/[Native Datastore^1^]
//
| *Azure NetApp Files (ANF)*
^| link:azure-guest.html#anf[Guest Connected]
...
| *FSx ONTAP*
^| N/A
^| link:aws-guest.html#fsx-ontap[Guest Connected]
