...
For sample step-by-step instructions on setting up SnapCenter and replicating the data, Refer https://docs.netapp.com/us-en/netapp-solutions/ehc/aws-guest-dr-config-snapmirror.html[Setup Replication with SnapCenter]
