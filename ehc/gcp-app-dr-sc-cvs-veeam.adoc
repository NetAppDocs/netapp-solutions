...
For sample step-by-step instructions on setting up SnapCenter and replicating the data, Refer to link:aws-guest-dr-config-snapmirror.html[Setup Replication with SnapCenter]
