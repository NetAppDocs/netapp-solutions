...
[%collapsible]
=====
For testing purposes, the lab environment from on-premises used for this validation was connected through a site-to-site VPN to Azure Virtual WAN hub, which allows on-premises connectivity to Azure VMware Solution.
...
To learn more about this process, feel free to follow the detailed walkthrough video and link this video:
