...
+
image::dr-veeam-gcnv-image17.png[General page]    STILL NEED TO CAPTURE IMAGE
+
{nbsp}
...
{nbsp}
+
image::dr-veeam-gcnv-image19.png[Boot order and delays]    STILL NEED TO CAPTURE IMAGE
+
{nbsp}
