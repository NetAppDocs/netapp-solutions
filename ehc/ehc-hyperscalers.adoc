...
.AWS
--
include::ehc/ehc-config-vmware.adoc[tags=aws-config;ehc-aws]
--
.Azure
--
include::ehc/ehc-config-vmware.adoc[tags=azure-config;ehc-azure]
--
.Google Cloud
--
include::ehc/ehc-config-vmware.adoc[tags=gcp-config;ehc-gcp]
--
====
...
.AWS
--
include::ehc/ehc-datastore.adoc[tags=aws-datastore;ehc-aws]
--
.Azure
--
include::ehc/ehc-datastore.adoc[tags=azure-datastore;ehc-azure]
--
.Google Cloud
--
include::ehc/ehc-datastore.adoc[tags=gcp-datastore;ehc-gcp]
--
====
