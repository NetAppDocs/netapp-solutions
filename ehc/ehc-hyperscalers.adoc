...
.Azure
--
include::ehc/ehc-config-vmware.adoc[tags=azure-config;ehc]
--
.AWS
--
include::ehc/ehc-config-vmware.adoc[tags=aws-config;ehc]
--
.Google Cloud
--
include::ehc/ehc-config-vmware.adoc[tags=gcp-config;ehc]
--
====
...
.Azure
--
include::ehc/ehc-datastore.adoc[tags=azure-datastore;ehc]
--
.AWS
--
include::ehc/ehc-datastore.adoc[tags=aws-datastore;ehc]
--
.Google Cloud
--
include::ehc/ehc-datastore.adoc[tags=gcp-datastore;ehc]
--
====
