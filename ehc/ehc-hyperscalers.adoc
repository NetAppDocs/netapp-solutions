...
.AWS / VMC
--
include::ehc/ehc-config-vmware.adoc[tags=aws-config;ehc-aws;!aws]
--
.Azure / AVS
--
include::ehc/ehc-config-vmware.adoc[tags=azure-config;ehc-azure;!azure]
--
.GCP / GCVE
--
include::ehc/ehc-config-vmware.adoc[tags=gcp-config;ehc-gcp;!gcp]
====
...
.AWS / VMC
--
include::ehc/ehc-datastore.adoc[tags=aws-datastore;ehc-aws;!aws]
--
.Azure / AVS
--
include::ehc/ehc-datastore.adoc[tags=azure-datastore;ehc-azure;!azure]
--
.GCP / GCVE
--
include::ehc/ehc-datastore.adoc[tags=gcp-datastore;ehc-gcp;!gcp]
====
