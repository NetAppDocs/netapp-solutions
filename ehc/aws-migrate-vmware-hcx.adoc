...
. Use an existing VMC SDDC or create a new SDDC following this https://docs.netapp.com/us-en/netapp-solutions/ehc/aws-setup.html[NetApp link^] or this https://docs.vmware.com/en/VMware-Cloud-on-AWS/services/com.vmware.vmc-aws.getting-started/GUID-EF198D55-03E3-44D1-AC48-6E2ABA31FF02.html[VMware link^].
