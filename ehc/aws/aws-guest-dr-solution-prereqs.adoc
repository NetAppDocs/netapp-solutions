...
For a list of steps to be completed on the SnapCenter Server residing in AWS, see the section link:aws-guest-dr-solution-overview#deploy-secondary-snapcenter[Deploy Secondary Windows SnapCenter Server].
=====
