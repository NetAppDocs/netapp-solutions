...
image:dr-veeam-image1.png["Diagram of DR scenario using Veeam Replication and FSx ONTAP for VMC"]
...
image::dr-veeam-image11.png[]

image::dr-veeam-image12.png[]
...
image::dr-veeam-image15.png[]

image::dr-veeam-image16.png[]
