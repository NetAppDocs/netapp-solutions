...
image::avs-logo.png[avs,width="150",float="right",align="center"]
...
image::vmc-logo.png[vmc,width="150",float="right",align="center"]
...
image::gcve-logo.png[gcve,width="150",float="right",align="center"]
