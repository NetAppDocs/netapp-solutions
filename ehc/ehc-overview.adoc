...
image:avs-logo.png[avs,30,30,float=left,align=center]
...
image:vmc-logo.png[vmc,30,30,float=left,align=center]
...
image:gcve-logo.png[gcve,30,30,float=left,align=center]
