...
image::avs-logo.png[avs,80,80,float=left,align=center]
...
image::vmc-logo.png[vmc,80,80,float=left,align=center]
...
image::gcve-logo.png[gcve,80,80,float=left,align=center]
