...
image::avs-logo.png[avs,width="100",float="left",align="center"]
...
image::vmc-logo.png[vmc,width="100",float="left",align="center"]
...
image::gcve-logo.png[gcve,width="100",float="left",align="center"]
