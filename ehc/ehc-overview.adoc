...
//Supplemental Datastore:: <enter the definition here>
...
// link:https://blogs.vmware.com/cloud/2021/12/01/vmware-cloud-on-aws-going-big-reinvent2021/[FSx ONTAP as a Supplemental datastore for AWS]
AWS press release for FSx ONTAP as a supplemental datastore COMING SOON!

link:https://docs.microsoft.com/en-us/azure/azure-vmware/attach-azure-netapp-files-to-azure-vmware-solution-hosts?branch=main&tabs=azure-portal/[Azure NetApp Files (ANF) as a supplemental datastore for Azure]
link:https://www.netapp.com/google-cloud/google-cloud-vmware-engine-registration/[Cloud Volumes Service (CVS) as a supplemental datastore for GCP]
