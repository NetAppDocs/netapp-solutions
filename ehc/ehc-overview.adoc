...
NOTE: NetApp storage as a datastore is currently available as Private preview in all the major hyperscale clouds.
...
NOTE: This applies to guest connected storage.
