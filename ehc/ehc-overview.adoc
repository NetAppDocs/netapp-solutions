...
image:avs-logo.png[avs,width=80,float=left,align=center]
...
image:vmc-logo.png[vmc,width=80,float=left,align=center]
...
image:gcve-logo.png[gcve,width=80,float=left,align=center]
