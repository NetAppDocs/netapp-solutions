...
* link:#register[Register the resource provider and create a private cloud]
* link:#connect[Connect to a new or existing ExpressRoute virtual network gateway]
* link:#validate[Validate the network connectivity and access the private cloud]
