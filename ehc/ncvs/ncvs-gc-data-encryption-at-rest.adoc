...
For information about configuring KMS for CVS-Performance, see https://cloud.google.com/architecture/partners/netapp-cloud-volumes/customer-managed-keys[Setting up customer-managed encryption keys^].
