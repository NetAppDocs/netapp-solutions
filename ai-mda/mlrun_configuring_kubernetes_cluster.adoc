---
sidebar: sidebar
permalink: mlrun_configuring_kubernetes_cluster.html
...
+
image:mlrun_image9.png[Error: Missing Graphic Image]

. Upload the Kubernetes config file. See the following image.
+
image:mlrun_image10.PNG[Error: Missing Graphic Image]
...
link:mlrun_define_persistent_volume_claim.html[Next: Define Persistent Volume Claim]
