...
* link:https://cloud.google.com/blog/products/compute/how-to-use-netapp-cvs-as-datastores-with-vmware-engine[How to use NetApp GCNV as datastores for Google Cloud VMware Engine (Google)]
