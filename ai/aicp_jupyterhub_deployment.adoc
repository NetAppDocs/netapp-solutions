...
Before deployment it is a good practice to optimize the JupyterHub deployment for your respective environment. You can create a *config.yaml* and utilize it during deployment using the Helm chart.
