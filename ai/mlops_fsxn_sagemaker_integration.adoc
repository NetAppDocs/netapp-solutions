---
sidebar: sidebar
permalink: ai/mlops_fsxn_sagemaker_integration.html
...
== Prerequisite
=== Network Environment
image:mlops_fsxn_sagemaker_integration_0.png[Error: Network environment]
...
image:mlops_fsxn_sagemaker_integration_1.png[Error: Training workflow]
