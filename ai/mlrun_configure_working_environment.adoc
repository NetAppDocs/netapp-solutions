...
image:mlrun_image13.png["Figure showing input/output dialog or representing written content"]

* `netapp/pipeline`. Contains utilities to handle NetApp Snapshot copies.

image:mlrun_image14.png["Figure showing input/output dialog or representing written content"]
...
image:mlrun_image15.png["Figure showing input/output dialog or representing written content"]
...
image:mlrun_image16.png["Figure showing input/output dialog or representing written content"]
...
image:mlrun_image17.png["Figure showing input/output dialog or representing written content"]

If you select the Snapshot step, you can see the name of the Snapshot copy that was used to run this experiment.

image:mlrun_image18.png["Figure showing input/output dialog or representing written content"]
...
image:mlrun_image19.png["Figure showing input/output dialog or representing written content"]
...
image:mlrun_image20.png["Figure showing input/output dialog or representing written content"]

For each job, we store additional details.

image:mlrun_image21.png["Figure showing input/output dialog or representing written content"]
