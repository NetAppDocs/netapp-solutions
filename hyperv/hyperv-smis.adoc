...
image:hyperv-smis-image13.png["Add a CIMuser"]
. To add a NetApp storage system, you can use the management IP address of the Storage Virtual Machine (SVM), and the credentials for the vsadmin user.
