...
// end::ent-db[]
// tag::automation[]
| 29/03/2023 | Automation | Updated blog "FSx for ONTAP Monitoring and Auto-Resizing using AWS Lambda Function" with options for private/public deployment along with manual/automated deployment options.
| 22/03/2023 | Automation | Added blog: FSx for ONTAP Monitoring and Auto-Resizing using AWS Lambda Function
// end::automation[]
// tag::ent-db[]
...
// end::ent-db[]
// tag::hmc[]
| 10/25/2022 | Hybrid Cloud | Added link to VMware docuemntation for FSx ONTAP as an NFS datastore
