...
// end::header[]
// tab::hmc[]
| 08/23/2022 | Hybrid Cloud | Revamped the presentation of the hyperscaler region availabilty status for AWS, Azure
// end::hmc[]
// tag::vmware[]
| 08/05/2022 | Virtualization | Added "Reboot Required infomration for recommended ESXi and ONTAP settings
// end::vmware[]
// tag::hmc[]
