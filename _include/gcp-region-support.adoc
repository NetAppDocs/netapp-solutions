The availability of supplemental NFS datastores on GCP / GCVE is defined by Google.  First, you need to determine if both GCVE and CVS are available in the region.  Next, you need to determine if the CVS supplemental NFS datastore is supported in that region.
