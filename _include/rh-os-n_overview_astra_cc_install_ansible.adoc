. To use Ansible playbooks to deploy Astra Control Center, you need an Ubuntu/RHEL machine with Ansible installed. Follow the procedures link:../automation/getting-started.html[here] for Ubuntu and RHEL.
