...
NOTE: NetApp supports its storage connected to any compute servers listed in https://www.vmware.com/resources/compatibility/search.php?deviceCategory=server[VMware Compatability Guide]. 
