...
NOTE: For more information on VMware vSphere Virtual Volumes, SPBM, and ONTAP, see https://www.netapp.com/pdf.html?item=/media/13555-tr4400.pdf[VMware vSphere Virtual Volumes with ONTAP, TR-4400^]
