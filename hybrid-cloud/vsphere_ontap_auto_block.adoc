...
| link:vsphere_ontap_auto_block_fc.adoc[Fibre Channel (FC)] | yes
| link:vsphere_ontap_auto_block_fcoe.adoc[Fibre Channel over Ethernet (FCoE)] | yes
| link:vsphere_ontap_auto_block_iscsi.adoc[iSCSI] | yes
| iSCSI Extensions for RDMA (iSER) | no
| link:vsphere_ontap_auto_block_nvmeof.adoc[NVMe over Fabric with FC (NVMe/FC)] | yes
