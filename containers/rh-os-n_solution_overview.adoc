...
* Combined power of enterprise container and virtualized workloads in with Red Hat Openshift deployed virtually on OSP, RHV, or vSphere, or on bare metal with OpenShift Virtualization.
...
link:rh-os-n_overview_openshft.html[Next: Red Hat OpenShift Overview]
