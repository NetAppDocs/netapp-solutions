...
. Enter the details of the new namespace, select the cluster you want to clone it to, and choose if you want to clone it from an existing snapshot or a backup or the current state of the application. Then click Next, and click Clone on the Review pane after you have reviewed the details.
+
