...
* link:anthos-with-netapp/a-w-n_trident_ontap_nfs.html[NetApp ONTAP NFS]

* link:anthos-with-netapp/a-w-n_trident_ontap_iscsi.html[NetApp ONTAP iSCSI]

* link:anthos-with-netapp/a-w-n_trident_element_iscsi.html[NetApp Element iSCSI]


link:anthos-with-netapp/a-w-n_use_cases.html[Next: Solution Validation/Use Cases: Red Hat OpenShift with NetApp.]
