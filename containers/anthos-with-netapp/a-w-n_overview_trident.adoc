...
NOTE: Helm is not installed by default on the GKE-Admin workstation. It can be downloaded in a binary format that will work with Ubuntu from the following website: https://helm.sh/docs/intro/install/[Helm Install Page]
