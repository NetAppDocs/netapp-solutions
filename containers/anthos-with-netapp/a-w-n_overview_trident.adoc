...
summary: Astra Trident is an open-source and fully-supported storage orchestrator for containers and Kubernetes distributions, including Anthos.
---
...
The latest version of Astra Trident, 22.01, was released in January 2022. A support matrix for what version of Trident has been tested with which Kubernetes distribution can be found https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators[here].
...
NOTE: Helm is not installed by default on the GKE-Admin workstation. You can easily install it using the apt tool available in Ubuntu.
...
link:a-w-n_use_cases.html[Next: Advanced Configuration Options: Anthos with NetApp.]
