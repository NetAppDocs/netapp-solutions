...
Amazon FSx ONTAP provides fully managed shared storage in the AWS Cloud with the popular data access and management capabilities of ONTAP. For more information about Amazon FSx ONTAP, click https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/what-is-fsx-ontap.html[here].
