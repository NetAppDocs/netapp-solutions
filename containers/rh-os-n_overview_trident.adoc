...
The latest version of Astra Trident is 21.07.1 released in August 2021. A support matrix for what version of Trident has been tested with which Kubernetes distribution can be found https://netapp-trident.readthedocs.io/en/stable-v21.07.1/support/requirements.html#supported-frontends-orchestrators[here].
...
.	Download the installation archive to the admin workstation and extract the contents. The current version of Trident is 21.07.1, which can be downloaded https://github.com/NetApp/trident/releases/download/v21.07.1/trident-installer-21.07.1.tar.gz[here].
+
----
...
Status:
  Current Installation Params:
    ...
    Autosupport Image:          netapp/trident-autosupport:21.07.1
    Autosupport Proxy:
