...
The latest version of Astra Trident is 21.07 released in July 2021. A support matrix for what version of Trident has been tested with which Kubernetes distribution can be found https://netapp-trident.readthedocs.io/en/stable-v21.07/support/requirements.html#supported-frontends-orchestrators[here].
