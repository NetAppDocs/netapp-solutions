...
NDE delivers a simple and streamlined deployment experience for the NetApp HCI solution. A detailed guide to using NDE 1.6 to deploy your NetApp HCI system can be found link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2856899[here^].
