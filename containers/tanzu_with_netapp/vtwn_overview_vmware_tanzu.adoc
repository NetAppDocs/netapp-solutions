...
To understand more about the different offerings and their capabilities in the Tanzu portfolio, visit the documentation https://docs.vmware.com/en/VMware-Tanzu/index.html[^here].
