...
NOTE: The instructions below are screen capped from a Trident 21.01 install, but the same steps to manually deploy the Trident Operator apply to the current 21.04 releas as well.
