...
**PLEASE NOTE THAT AS OF JUNE 2024, THE VALIDATED DATA PROTECTION AND DATA MIGRATION SOLUTIONS USING ASTRA CONTROL CENTER AND ASTRA CONTROL SERVICE ARE ONLY AVAILABLE FOR CUSTOMERS WHO ARE CURRENTLY USING THEM. AS OF ASTRA 24.06, THE TWO PRODUCTS ARE NOT AVAILABLE TO NEW CUSTOMERS.**

**WHEN A VERSION OF ASTRA TRIDENT WITH ADDITIONAL FUNCTIONALITIES FOR DATA PROTECTION AND MIGRATION BECOMES AVAILABLE, WE WILL PROVIDE DETAILS OF USING THE ADVANCED FUNCTIONALITIES.**

**WE HAVE INCLUDED A 3rd PARTY SOLUTION FOR DATA PROTECTION USING THE OPENSHIFT API FOR DATA PROTECTION (OADP) WITH VELERO.**  
