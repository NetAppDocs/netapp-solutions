...
Blog: link:http://netapp.com[Using Astra Control Service to manage stateful applications on a fully managed Red Hat OpenShift Service on AWS (ROSA) cluster with Amazon FSx for NetApp ONTAP]
...
==== **Create an admin user and login to the cluster**
