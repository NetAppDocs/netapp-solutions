...
* Deploy a CVO instance in Azure using the connector. Refer to instructions https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-getting-started-azure.html [here.]
