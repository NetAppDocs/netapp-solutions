...
<div>
<strong>
<textarea style = "padding: 0; margin-bottom: auto; border-width:1px; border-style:solid; height: 110px; width: 190px">
...
<strong>
<textarea style = "padding: 0; margin-bottom: auto; border-width:1px; border-style:solid; height: 170px; width: 400px">
...
<strong>
<textarea style = "padding: 0; margin-bottom: auto; border-width:1px; border-style:solid; height: 100px; width: 200px">
...
<strong>
<textarea style = "padding: 0; margin-bottom: auto; border-width:1px; border-style:solid; height: 300; width: 400px">
