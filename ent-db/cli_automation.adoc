...
ansible-playbook -i hosts all_playbook.yml -u <span <div contenteditable="true" style="color:#0000FF
; font-weight:bold; font-style:italic; text-decoration:underline;;"/>username<i></i></span> -k -K -t ontap_config
</section>
<section>
<div>
<strong>5.2</strong>
...
<div class="listingblock"><div class="content"><div><button id="copy-button1" onclick="CopyClassText1()">Copy</button></div><pre><code><div class="CopyMeClass1" id="CopyMeID1">
ansible-playbook -i hosts all_playbook.yml -u <span <div contenteditable="true" style="color:#0000FF
; font-weight:bold; font-style:italic; text-decoration:underline;;"/>username<i></i></span> -k -K -t linux_config
</section></section>
<div>
...
<div class="listingblock"><div class="content"><div><button id="copy-button1" onclick="CopyClassText1()">Copy</button></div><pre><code><div class="CopyMeClass1" id="CopyMeID1">
ansible-playbook -i hosts all_playbook.yml -u <span <div contenteditable="true" style="color:#0000FF
; font-weight:bold; font-style:italic; text-decoration:underline;;"/>username<i></i></span> -k -K -t oracle_config
</div></section>
<div>
...
<div class="listingblock"><div class="content"><div><button id="copy-button1" onclick="CopyClassText1()">Copy</button></div><pre><code><div class="CopyMeClass1" id="CopyMeID1">
ansible-playbook -i hosts all_playbook.yml -u <span <div contenteditable="true" style="color:#0000FF
; font-weight:bold; font-style:italic; text-decoration:underline;;"/>username<i></i></span> -k -K
</section>
<div>
