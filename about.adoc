...
[aqua]#AI Converged Infrastructures#
[aqua]#Data Pipelines, Data Lakes and Management#
[aqua]#Use Cases#
//
...
[teal]#Virtual Desktop Service (VDS)#
[teal]#VMware Horizon#
[teal]#Citrix Virtual Apps and Desktops#
[teal]#Virtual Desktop Applications#
//
| Containers
