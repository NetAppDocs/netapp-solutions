...
//
| [blue]#Hybrid Cloud / Virtualization#
| Collection of hybrid cloud core solutions.  Solutions are sub-classified into one of the following categories:
[blue]#VMware Virtualization#
[blue]#VMware Private Cloud#
[blue]#Red Hat Private Cloud#
[blue]#Workload Performance#
//
| [blue]#Virtual Desktops#
| Collection of end user computing solutions.  Solutions are sub-classified into one of the following categories:
[blue]#Virtual Desktop Service (VDS)#
[blue]#VMware Horizon#
[blue]#Citrix Virtual Apps and Desktops#
[blue]#Virtual Desktop Applications#
//
| [blue]#Containers#
