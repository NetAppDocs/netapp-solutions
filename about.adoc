...
| Collection of AI based solutions.  Solutions are sub-classified into one of the following categories: _[.underline]#AI Converged Infrastructures#_, _[.underline]#Data Pipelines, Data Lakes and Management#_, or _[.underline]#Use Cases#_
//
| Modern Data Analytics
| Collection of Data Analytics solutions (e.g. Splunk SmartStore, Apache Spark, etc.)
//
| Hybrid Cloud / Virtualization
| Collection of hybrid cloud core solutions.  Solutions are sub-classified into one of the following categories: _[.underline]#VMware Virtualization#_, _[.underline]#VMware Private Cloud#_, _[.underline]#Red Hat Private Cloud#_, or _[.underline]#Workload Performance#_
//
| Virtual Desktops
| Collection of end user computing solutions.  Solutions are sub-classified into one of the following categories: _[.underline]#Virtual Desktop Service (VDS)#_, _[.underline]#VMware Horizon#_, _[.underline]#Citrix Virtual Apps and Desktops#_, or _[.underline]#Virtual Desktop Applications#_
//
| Containers
| Collection of container based solutions.  Solutions are sub-classified into one of the following categories: _[.underline]#Red Hat OpenShift#_, or _[.underline]#Google Anthos#_
//
| Business Applications
| Collection of business applications solutions. Solutions are sub-classified into one of the following categories: _[.underline]#SAP#_
//
| Enterprise Database
| Collection of database solutions.  Solutions are sub-classified into one of the following categories: _[.underline]#SAP HANA#_, _[.underline]#Oracle#_, or _[.underline]#Microsoft SQL Server#_
//
