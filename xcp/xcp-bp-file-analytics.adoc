...
image::xcp-bp_image6.png["Figure showing input/output dialog or representing written content"]
...
image::xcp-bp_image7.png["Figure showing input/output dialog or representing written content"]
