---
sidebar: sidebar
permalink: xcp-bp_sizing_guidelines_overview.html
...
The link types are soft links, hard links, and multilinks. Soft links are considered normal files. The size of the files is not relevant for the time to complete the XCP sync operation.
