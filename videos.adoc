...
|===
.>|
.SQL Server on AWS EC2 using Amazon FSx for NetApp ONTAP (Configure Storage for SQL Server and deploy Snapcenter for Backup, Restore and clone operations)
video::SQLonFSxN.mp4[]
.>|
.>|
|===
