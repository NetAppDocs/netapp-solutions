...
video::36ecf505-5d1d-4e99-a6f8-b11c00341793[panopto, title="Snapshot/Restore for Applications   on Red Hat OpenShift Service on AWS (ROSA)clusters with Amazon FSx for NetApp ONTAP storage",width=360]
...
[%collapsible]
====
* link:vmware/vsphere_demos_videos.html[VMware Video Collection]
====
...
[%collapsible]
====
* link:containers/a-w-n_videos_and_demos.html[NetApp with Google Anthos Videos]
* link:containers/vtwn_videos_and_demos.html[NetApp with VMware Tanzu Videos]
* link:containers/dwn_videos_and_demos.html[NetApp for DevOps Videos]
